...
function Profile() {
      ...
      <main className={styles.main}>
        ...
        <div className={styles.profileContainer}>
          <div className={styles.profileHeader}>
            ...
            <div>
              <h2>{userData?.first_name || userData?.username || "User"}</h2>
          ...
          <div className={styles.profileActions}>
            <button className={styles.changePassBtn} onClick={openEditProfile}>
              Edit Profile
            </button>
          </div>
        </div>
  ...
  />
            ...
            <div className={styles.modalButtons}>
              ...
              <button className={styles.submitBtn} onClick={updateProfile}>
                Save Profile
              </button>
